...
import time 
#data address 
path='C:/1/flower_photos/' 
#model saving address 
model_path='C:/1/flower_photos/model2.ckpt' 
#make each image resize 100*100 
...
#Divide all data into training and validation sets 
ratio=0.8 
...
#could increase the number of n_epoch for training 
n_epoch=100 
batch_size=64 
